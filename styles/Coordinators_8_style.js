var size = 0;
var placement = 'point';
function categories_Coordinators_8(feature, value, size, resolution, labelText,
...
case '7) Circular Economy Partnership of the UAEU (2017-2020)':
        ...
        image: new ol.style.Icon({
                  ...
                  anchorYUnits: "pixels",
                  rotation: 0.0,
                  src: "styles/Coordinator_Red.svg"
            }),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
...
var style_Coordinators_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Coordinators_8(feature, value, size, resolution, labelText,
